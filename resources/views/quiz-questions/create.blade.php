                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                            ...
                            <div class="p-6">
                                <h3 class="text-lg font-bold text-slate-800 mb-4 uppercase tracking-wider">Informasi
                                    Dasar</h3>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="title" value="{{ old('title') }}" required
                                            ...
                                            placeholder="Contoh: Pre-test Kebersihan Tangan">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="quiz_type"
                                            ...
                                            <option value="pre_test"
                                                {{ old('quiz_type') == 'pre_test' ? 'selected' : '' }}>Pre-Test</option>
                                            <option value="post_test"
                                                {{ old('quiz_type') == 'post_test' ? 'selected' : '' }}>Post-Test
                                            </option>
                                            <option value="evaluation"
                                                {{ old('quiz_type') == 'evaluation' ? 'selected' : '' }}>Evaluasi
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="description" rows="3"
                                            class="w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 transition-all"
                                            placeholder="Tuliskan petunjuk pengerjaan quiz...">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="pt-4 border-t border-slate-100">
                                    ...
                                    <div class="flex bg-slate-100 p-1 rounded-xl">
                                        <label
                                            ...
                                            <input type="radio" name="status" value="draft" class="hidden" checked>
                                            Draft
                                        </label>
                                        <label
                                            class="flex-1 text-center py-2 rounded-lg cursor-pointer transition-all has-[:checked]:bg-white has-[:checked]:shadow-sm has-[:checked]:text-indigo-600 text-slate-500 font-medium">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden min-h-full">
                            ...
                            <div class="p-8">
                                <div class="flex justify-between items-center mb-8">
                                    <div>
                                        <h3 class="text-2xl font-bold text-slate-800">Daftar Pertanyaan</h3>
                                        <p class="text-slate-500 text-sm mt-1">Kelola soal-soal untuk quiz ini secara
                                            dinamis.</p>
                                    </div>
                                ...
                                <div class="space-y-8 relative">
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-between items-start mb-6">
                                                <div class="flex items-center">
                                                    ...
                                                    <h4 class="font-bold text-slate-700">Pertanyaan Baru</h4>
                                                </div>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                                <div class="md:col-span-3">
                                                    <label
                                                        ...
                                                        Pertanyaan</label>
                                                    <textarea :name="'questions[' + qIndex + '][text]'" required
                                                        class="w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 transition-all"
                                            ...
                                            <div x-show="question.type === 'multiple_choice'" x-transition>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <template x-for="(opt, oIndex) in question.options"
                                                        :key="oIndex">
                                                        <div
                                                            class="flex items-center space-x-2 bg-white p-3 border border-slate-200 rounded-xl">
                                                            <input type="radio"
                                                                :name="'questions[' + qIndex + '][is_correct]'"
                                                                :value="oIndex" required
                                            ...
                                            <div x-show="question.type === 'true_false'" x-transition>
                                                ...
                                                <div class="flex space-x-4">
                                                    <label
                                                        ...
                                                        <input type="hidden"
                                                            :name="'questions[' + qIndex + '][options][0]'" value="Benar">
                                                    </label>
                                                    <label
                                    ...
                                    <div x-show="questions.length === 0"
                                        ...
                                        <p class="font-medium">Belum ada soal. Klik tombol di atas untuk menambah.</p>
                                    </div>
                                </div>
