...
<body class="bg-slate-950 text-white antialiased">
    <div class="relative min-h-screen overflow-hidden">
        ...
        <div class="absolute inset-0">
            <div
                class="absolute left-1/2 top-[-140px] h-[320px] w-[320px] -translate-x-1/2 rounded-full bg-indigo-500/20 blur-3xl">
            </div>
            <div class="absolute right-[-80px] top-1/3 h-[260px] w-[260px] rounded-full bg-cyan-400/10 blur-3xl"></div>
            <div
                class="absolute bottom-[-120px] left-[-60px] h-[280px] w-[280px] rounded-full bg-fuchsia-500/10 blur-3xl">
            </div>
            <div
                class="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.06),transparent_35%),linear-gradient(to_bottom_right,rgba(255,255,255,0.02),transparent,rgba(255,255,255,0.02))]">
            </div>
        </div>
        ...
        <div class="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 py-10 sm:px-8 lg:px-12">
            <div class="grid w-full items-center gap-12 lg:grid-cols-2">
                ...
                <div class="order-2 text-center lg:order-1 lg:text-left">
                    <div
                        class="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm font-medium tracking-wide text-slate-200 backdrop-blur">
                    ...
                    <h1 class="mt-6 text-4xl font-semibold leading-tight text-white sm:text-5xl lg:text-6xl">
                        ...
                        <span
                            class="bg-gradient-to-r from-cyan-300 via-blue-400 to-indigo-400 bg-clip-text text-transparent">
                            system maintenance
                        </span>
                    </h1>

                    <p class="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg lg:mx-0">
                        Our website is temporarily unavailable while we carry out server migration and infrastructure
                        improvements.
                        This maintenance is intended to ensure a more stable, secure, and reliable experience once the
                        system is back online.
                    </p>

                    <div
                        class="mt-8 h-px w-full max-w-md bg-gradient-to-r from-white/20 via-white/5 to-transparent mx-auto lg:mx-0">
                    </div>
                    ...
                    <p class="mt-8 text-sm leading-7 text-slate-400">
                        We appreciate your patience and understanding while this work is being completed.
                    </p>
                </div>
                ...
                <div class="order-1 lg:order-2">
                    <div
                        class="rounded-[32px] border border-white/10 bg-white/5 p-4 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-6">
                        <div class="rounded-[24px] bg-gradient-to-br from-white/5 to-white/[0.02] p-4 sm:p-6">
                            <svg class="mx-auto w-full max-w-2xl" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                viewBox="0 0 945 583.2243" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <path id="b0cf38c7-358d-48dc-a444-e9782686dfa5-94" data-name="Path 438"
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#e5e7eb" />
                                <path id="acbbaa8b-0bc2-4bc9-96d7-93dd88f90f19-95" data-name="Path 439"
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#f8fafc" />
                                ...
                                <path
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#f1f5f9" />
                                <rect x="500.27353" y="273.88471" width="70.06181" height="7.96157" fill="#1e293b" />
                                <circle cx="662.68956" cy="278.66165" r="4.77694" fill="#1e293b" />
                                <circle cx="678.6127" cy="278.66165" r="4.77694" fill="#1e293b" />
                                <circle cx="694.53583" cy="278.66165" r="4.77694" fill="#1e293b" />
                                <path
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#f1f5f9" />
                                <rect x="500.27353" y="386.939" width="70.06181" height="7.96157" fill="#1e293b" />
                                <circle cx="662.68956" cy="391.71594" r="4.77694" fill="#1e293b" />
                                <circle cx="678.6127" cy="391.71594" r="4.77694" fill="#1e293b" />
                                <circle cx="694.53583" cy="391.71594" r="4.77694" fill="#1e293b" />
                                <path
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#f1f5f9" />
                                <rect x="500.27353" y="499.99329" width="70.06181" height="7.96157" fill="#1e293b" />
                                <circle cx="662.68956" cy="504.77024" r="4.77694" fill="#1e293b" />
                                <circle cx="678.6127" cy="504.77024" r="4.77694" fill="#1e293b" />
                                <circle cx="694.53583" cy="504.77024" r="4.77694" fill="#1e293b" />
                                <path
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#334155" />
                                <polygon
                                ...
                                <path
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#1e293b" />
                                <polygon
                                ...
                                <circle cx="523.48018" cy="202.31369" r="30.68251"
                                    transform="translate(-32.63308 406.2144) rotate(-61.33685)" fill="#fda4af" />
                                <path
                                ...
                                <path
                                    ...
                                    transform="translate(-127.5 -158.38785)" fill="#fda4af" />
                                <path
                                ...
                                <path d="M1071.5,741.38785h-943a1,1,0,0,1,0-2h943a1,1,0,0,1,0,2Z"
                                    transform="translate(-127.5 -158.38785)" fill="#cbd5e1" />
                            </svg>
                        </div>
                    </div>
                </div>
    ...
    <footer class="absolute bottom-0 left-0 right-0 z-10 border-t border-white/10 bg-black/10 backdrop-blur">
        <div class="mx-auto max-w-7xl px-6 py-4 text-center text-sm text-slate-400 sm:px-8 lg:px-12">
